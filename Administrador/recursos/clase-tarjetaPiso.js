...
class TarjetaPiso{
    ...
    get Card(){
        return this.obtenerTarjetaPiso();
    }

    obtenerTarjetaPiso(){
      
        
        const contCards = document.querySelector(".contenedorPisos");
...
*/
const tarjetas = new TarjetaPiso(listaOpciones,listaLinks);
tarjetas.obtenerTarjetaPiso();