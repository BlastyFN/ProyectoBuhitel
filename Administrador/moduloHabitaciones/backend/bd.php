...
class database
{
	...
	function obtenerHabs($hotel, $piso){
		$sql = $this->con->prepare("SELECT habitacion_ID, habitacion_nombre, habitacion_alias, habitacion_tipo, habitacion_estado,
	...
	function eliminarHab($hab, $hotel){  //Añadir condicinal al hotel
		$sqlGetId = $this->con->prepare("SELECT habitacion_id FROM habitacion 
