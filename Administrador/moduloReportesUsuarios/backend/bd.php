...
class database
{
	...
	function obtenerReportes($hotel){
		...
		ORDER BY categoriareporte.CatReporte_Prioridad ASC
");
		$sql->execute();
		$res = $sql->fetchall();
    ...
    function obtenerReporteEspecifico($reporte_id){
		...
		categoriareporte.CatReporte_Nombre, categoriareporte.CatReporte_ID, reporte.Reporte_Contenido, reporte.Reporte_usuario, 
